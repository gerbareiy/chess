...
BOOST_AUTO_TEST_CASE(IsDontHaveMoves_Test)
{
	...
	auto blackKing = std::make_shared<Chess::Rook>(Chess::ePieceColor::BLACK, Chess::Coordinate('A', 1));
	auto blackRook1 = std::make_shared<Chess::Rook>(Chess::ePieceColor::BLACK, Chess::Coordinate('C', 4));
	auto blackRook2 = std::make_shared<Chess::Rook>(Chess::ePieceColor::BLACK, Chess::Coordinate('C', 6));
...
BOOST_AUTO_TEST_CASE(SeventyFiveMovesLogic_Test)
{
	...
	auto blackKing = std::make_shared<Chess::Rook>(Chess::ePieceColor::BLACK, Chess::Coordinate('A', 1));
	auto blackRook = std::make_shared<Chess::Rook>(Chess::ePieceColor::BLACK, Chess::Coordinate('C', 6));
	auto whiteKing = std::make_shared<Chess::King>(Chess::ePieceColor::WHITE, Chess::Coordinate('D', 5));
