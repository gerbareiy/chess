...
Chess::Coordinate Chess::PieceTakeLocator::Find(const std::shared_ptr<IPiece>& piece, const std::vector<std::shared_ptr<IPiece>>& piecesOnBoard, Coordinate to) const
{
